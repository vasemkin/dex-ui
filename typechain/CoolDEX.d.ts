...
interface CoolDEXInterface extends ethers.utils.Interface {
  functions: {
...
export class CoolDEX extends BaseContract {
  ...
  filters: {
    "Deposit(address,uint256,uint256)"(
      ...
      [string, BigNumber, BigNumber],
      { _from: string; _tokenValue: BigNumber; _ethValue: BigNumber }
    >;
    ...
    "Withdraw(address,uint256,uint256)"(
      ...
      [string, BigNumber, BigNumber],
      { _to: string; _tokenValue: BigNumber; _ethValue: BigNumber }
    >;
